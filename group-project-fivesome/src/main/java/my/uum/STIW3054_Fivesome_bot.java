...
public class STIW3054_Fivesome_bot extends TelegramLongPollingBot {
    ...
    int stepBook = 0, stepCancel = 0, stepEdit = 0, stepApply = 0, stepCheck = 0, stepVerify = 0, stepRegister = 0, stepUpdate = 0;
        ...
        if (text.equals("/start") || text.equals("0") || text.equals("/systemadmin") || text.equals("/schooladmin") || text.equals("/user")) {
            ...
            if (approvedAdmin.equals("true")) {
                switch (text) {
                    ...
                    case "/updateroom": {
                        sendMessage.setChatId(chatId);
                        sendMessage.setText(SQLite.listMeetingRoom(School.getSchoolId() + "May you provide your school ID?"));
                        stepUpdate = 1;
                        break;
                    }
                    case "/checkstatus": {
...
//                    String rr = SQLite.searchRoom(Room.getRoomId());
//                    SQLite.updateDisplay(Room.getRoomId());
//                    if (rr.equals("No")) {
//                        sendMessage.setText("Sorry, I can't find the booked meeting room with this room id,please enter again\n\nReply 0: Back to Main Menu");
//                    } else {
//                        stepUpdate = 2;
//                        sendMessage.setText("Please provide your password\n\nReply 0: Back to Main Menu");
//                    }
...
//
//                    sendMessage.setChatId(chatId);
//                    String rr = SQLite.updateDisplay(User_list.getPassword());
//                    if (rr.equals("No")) {
//                        sendMessage.setText("Sorry, your password is wrong, please enter again\n\nReply 0: Back to Main Menu");
//                    } else {
//                        stepEdit = 3;
